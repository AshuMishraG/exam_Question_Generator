...
def generate_prompt(question_type):
    ...
    "Explanation": "brief explanation of the correct answer.",
     "Multimedia": "If the question benefits from a multimedia component (image, audio, video), mention its use case and include a brief description, otherwise return empty string."
    }}
...
def process_response(response):
    try:
        ...
        # Multimedia fields
        img_url = "https://example.com/image.jpg" if "image" in multimedia.lower() else ""
